...
namespace BankingApp.Controllers
{
    ...
    public class BankController : ControllerBase
    {
        ...
        [Authorize(Roles = "Admin")]
        public IActionResult DeleteEmployees(string bankEmail)
        {
        ...
        [Authorize(Roles = "Admin")]
        public IActionResult UpdateBankPassword(string bankEmail, UpdateBankPasswordDto updateBankPasswordDto)
        {
            var bankEntity = bankServices.UpdateBankPassword(bankEmail, updateBankPasswordDto);
            return Ok("Password Updated Successfully");
        }

        [HttpGet("get-by-bank-id/{bankEmail}")]
        [Authorize(Roles = "Admin")]
